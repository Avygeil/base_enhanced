...
#define ACCOUNTFLAG_BOOST_FIXIDIOTICFORCECONFIG	( 1ll << 31ll )
...
extern vmCvar_t		g_vote_betaMapForceInclude;
...
extern vmCvar_t		g_outOfBandDMs;
...
extern vmCvar_t		g_broadcastForceLoadouts;
