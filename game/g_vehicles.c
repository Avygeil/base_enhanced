...
#ifdef _JK2MP
extern gentity_t *NPC_Spawn_Do( gentity_t *client_ent, gentity_t *ent );
...
#ifdef QAGAME
						/*
						server crashes here, somehow happens:
						pVeh->m_ppPassengers[k-1] == 0
						which was previously
						pVeh->m_ppPassengers[k]
						*/
