...
const char *const v20Upgrade = "DROP VIEW [accountstats]; "
"CREATE VIEW [accountstats] AS "
"WITH wins AS ( "
"SELECT account_id, playerpugteampos.pos, count() AS wins "
"FROM playerpugteampos "
...
"avg(grips * (1200000.0 / playerpugteampos.duration)) AS avg_grips, "
"avg(gripped * (1200000.0 / playerpugteampos.duration)) AS avg_gripped, "
"CAST(sum(dark * playerpugteampos.duration) AS FLOAT) / CAST(sum(playerpugteampos.duration) AS FLOAT) AS avg_dark "
"FROM playerpugteampos "
"JOIN sessions ON playerpugteampos.session_id = sessions.session_id "
"JOIN accounts ON accounts.account_id = sessions.account_id "
"JOIN pugs ON pugs.match_id = playerpugteampos.match_id "
...
static qboolean UpgradeDBToVersion20(sqlite3 *dbPtr) {
...
const char *const v22Upgrade = "UPDATE playerratings SET rating = CASE WHEN rating = 12 THEN rating + 7 ELSE rating + 6 END;";

static qboolean UpgradeDBToVersion22(sqlite3 *dbPtr) {
	return trap_sqlite3_exec(dbPtr, v22Upgrade, NULL, NULL, NULL) == SQLITE_OK;
}

const char *const v23Upgrade = "ALTER TABLE playerratings ADD COLUMN [datetime] INTEGER;";

static qboolean UpgradeDBToVersion23(sqlite3 *dbPtr) {
	return trap_sqlite3_exec(dbPtr, v23Upgrade, NULL, NULL, NULL) == SQLITE_OK;
}

const char *const v24Upgrade = "CREATE TABLE addeditems ("
...
static qboolean UpgradeDBToVersion24(sqlite3 *dbPtr) {
...
const char *const v26Upgrade = "ALTER TABLE addeditems ADD COLUMN [suspended] INTEGER NOT NULL DEFAULT 0;";

static qboolean UpgradeDBToVersion26(sqlite3 *dbPtr) {
	return trap_sqlite3_exec(dbPtr, v26Upgrade, NULL, NULL, NULL) == SQLITE_OK;
}

const char *const v27Upgrade = "CREATE TABLE tedata (match_id INTEGER NOT NULL, "
"session_id INTEGER NOT NULL, "
"team INTEGER NOT NULL, "
"pos INTEGER, "
"time INTEGER NOT NULL, "
"numEnergizes INTEGER NOT NULL, "
"energizedAlly INTEGER NOT NULL, "
"numTEs INTEGER NOT NULL, "
"numTEsWithLOS INTEGER NOT NULL, "
"amountTE INTEGER NOT NULL, "
"amountTEWithLOS INTEGER NOT NULL, "
"numTEsFC INTEGER NOT NULL, "
"numTEsFCWithLOS INTEGER NOT NULL, "
"amountTEFC INTEGER NOT NULL, "
"amountTEFCWithLOS INTEGER NOT NULL, "
"numTEsChase INTEGER NOT NULL, "
"numTEsChaseWithLOS INTEGER NOT NULL, "
"amountTEChase INTEGER NOT NULL, "
"amountTEChaseWithLOS INTEGER NOT NULL, "
"FOREIGN KEY (match_id) REFERENCES pugs(match_id) ON DELETE CASCADE); ";

static qboolean UpgradeDBToVersion27(sqlite3 *dbPtr) {
...
const char *const v30Upgrade =
"ALTER TABLE accounts ADD COLUMN [bannedPos] INTEGER NOT NULL DEFAULT 0;";

static qboolean UpgradeDBToVersion30(sqlite3 *dbPtr) {
...
const char *const v33Upgrade =
"BEGIN TRANSACTION; "
"DROP VIEW IF EXISTS [accountstats]; "
"CREATE TABLE IF NOT EXISTS [playerpugteampos_new] ("
"    [playerpugteampos_id] INTEGER PRIMARY KEY AUTOINCREMENT, "
"    [match_id] INTEGER NOT NULL, "
"    [session_id] INTEGER NOT NULL, "
"    [team] INTEGER NOT NULL, "
...
"); "
"INSERT INTO [playerpugteampos_new] SELECT * FROM [playerpugteampos]; "
"DROP TABLE [playerpugteampos]; "
"ALTER TABLE [playerpugteampos_new] RENAME TO [playerpugteampos]; "
"CREATE VIEW [accountstats] AS "
"WITH wins AS ( "
"SELECT account_id, playerpugteampos.pos, count() AS wins "
"FROM playerpugteampos "
...
// fixes missing [team] from UNIQUE in playerpugteampos (also drops and remakes accountstats, which references playerputeampos)
static qboolean UpgradeDBToVersion33(sqlite3 *dbPtr) {
	return trap_sqlite3_exec(dbPtr, v33Upgrade, NULL, NULL, NULL) == SQLITE_OK;
}
...
static qboolean UpgradeDB( int versionTo, sqlite3* dbPtr ) {
	...
	switch ( versionTo ) {
		...
		case 33: return UpgradeDBToVersion33(dbPtr);
;		default:
