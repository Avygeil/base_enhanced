...
"CAST (sum(cap) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_cap, "
"CAST (sum(ass) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_ass, "
"CAST (sum(def) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_def, "
...
"CAST (sum(air) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_air, "
"CAST (sum(tk) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_tk, "
"CAST (sum(take) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_take, "
"CAST (sum(pitkil) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_pitkil, "
"CAST (sum(pitdth) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_pitdth, "
"CAST (sum(dmg) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_dmg, "
"CAST (sum(fcdmg) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_fcdmg, "
"CAST (sum(clrdmg) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_clrdmg, "
"CAST (sum(othrdmg) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_othrdmg, "
"CAST (sum(dmgtkn) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_dmgtkn, "
"CAST (sum(fcdmgtkn) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_fcdmgtkn, "
"CAST (sum(clrdmgtkn) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_clrdmgtkn, "
"CAST (sum(othrdmgtkn) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_othrdmgtkn, "
"CAST (sum(fckil) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_fckil, "
...
"CAST (sum(ret) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_ret, "
"CAST (sum(sk) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_sk, "
"CAST (sum(ttlhold) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_ttlhold, "
"CAST (sum(maxhold) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_maxhold, "
"CAST (sum(avgspd) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_avgspd, "
"CAST (sum(topspd) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_topspd, "
"CAST (sum(boon) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_boon, "
"CAST (sum(push) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_push, "
"CAST (sum(pull) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_pull, "
"CAST (sum(heal) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_heal, "
"CAST (sum(te) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_te, "
...
"CAST (sum(enemynrg) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_enemynrg, "
"CAST (sum(absorb) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_absorb, "
"CAST (sum(protdmg) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_protdmg, "
"CAST (sum(prottime) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_prottime, "
"CAST (sum(rage) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_rage, "
"CAST (sum(drain) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_drain, "
"CAST (sum(drained) AS FLOAT) / (CAST (sum(playerpugteampos.duration) AS FLOAT) / 1200000) AS avg_drained, "
...
"ORDER BY accounts.account_id ASC, playerpugteampos.pos ASC;";
